...
export default function StockPesajesLista() {
  ...
  return (
    ...
    >
      ...
      <div
        id="pesajes-print"
        className="bg-white rounded-2xl border border-[#dce8fd] p-3 md:p-4"
      >
        {loading ? (
                ...
                return (
                  <div key={idx} className="bg-white border border-slate-200 p-4 rounded-lg shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-bold text-[#0b1a38] text-base">{r.producto}</h4>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm text-gray-700 mb-2">
                      <div>
                        ...
                        <span className={`font-medium ${r.tipo_mov === 'ENTRADA' ? 'text-[#1e408f]' : r.tipo_mov === 'SALIDA' ? 'text-red-700' : ''}`}>
                          {movLabel(r.tipo_mov)}
                        </span>
                      </div>
