...
export default function FormBuilder({
  ...
  const renderField = (f) => {
    ...
    const common =
      "border border-[#cfdcd3] rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#0b1a38] w-full";

    const Label = f.label ? (
      <label className="text-sm text-[#0b1a38] mb-1 font-medium">{f.label}</label>
    ) : null;
